...
namespace AI_DND_Member_Console
{
	internal class Program
	{
		...
		static void RunAsDM()
		{
			...
			{
				memoryBuilder.AppendLine(SystemPromptAIPlayer);
				memoryBuilder.AppendLine(CharacterSheet.FromTemplate(1).ToString());
